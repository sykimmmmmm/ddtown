...
<head>
    ...
    <title>공지사항 수정 - DDTOWN 직원 포털</title>
			...
			<main class="emp-content" style="position:relative; min-height:600px;">
				...
				<nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
	                <ol class="breadcrumb">
	                    ...
	                    <li class="breadcrumb-item"><a href="/emp/community/notice/detail/${noticeVO.comuNotiNo}" style="color:black;">공지사항 상세 정보</a></li>
                ...
                <div class="form-view-container">
                    ...
                    <form method="post" action="<c:url value='/emp/community/notice/mod/${noticeVO.comuNotiNo}'/>" enctype="multipart/form-data">
                        ...
                        <table class="form-table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" id="comuNotiTitle" name="comuNotiTitle" value="<c:out value='${noticeVO.comuNotiTitle}'/>" required></td>
                                </tr>
                                <tr>
                                    <th><label for="comuNotiContent">내용</label></th>
                                    <td><textarea id="comuNotiContent" name="comuNotiContent" required><c:out value='${noticeVO.comuNotiContent}'/></textarea></td>
                                </tr>
                                <c:if test="${not empty noticeVO.attachmentFileList}">
                                    <tr>
                                        <th>기존 첨부파일 삭제</th>
                                        <td>
                                            <ul class="attachment-list-edit">
                                            <c:forEach var="file" items="${noticeVO.attachmentFileList}">
                                                <li>
                                                    ...
                                                    <img src="<c:url value='${file.webPath}'/>" alt="미리보기"/>
                                                    <label for="delFile_${file.attachDetailNo}">
                                                        <c:out value="${file.fileOriginalNm}"/> (<c:out value="${file.fileFancysize}"/>) - 삭제하려면 체크
                                                    </label>
                                                </li>
                                            </c:forEach>
                                            </ul>
                                ...
                                <tr>
                                    <th><label for="comuNotiFiles">새 첨부파일 추가</label></th>
                        ...
                        <div class="actions-container">
                            <c:url var="listUrl" value="/emp/community/notice/detail/${noticeVO.comuNotiNo}">
